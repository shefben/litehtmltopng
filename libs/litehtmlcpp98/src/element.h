...
namespace litehtml
{
	...
	class element : public lhmemory_enable_shared_from_this<element>
	{
	...
	public:
		typedef lhmemory_shared_ptr<litehtml::element>		ptr;
		typedef lhmemory_weak_ptr<litehtml::element>		weak_ptr;
	protected:
		lhmemory_weak_ptr<element>		m_parent;
		lhmemory_weak_ptr<litehtml::document>	m_doc;
		litehtml::box*				m_box;
	...
	public:
		element(const lhmemory_shared_ptr<litehtml::document>& doc);
		virtual ~element();
		...
		lhmemory_shared_ptr<document>	get_document() const;
	...
	inline lhmemory_shared_ptr<document> element::get_document() const
	{
		return m_doc.lock();
	}
}

...
litehtml::media_query::ptr litehtml::media_query::create_from_string(const tstring& str, const lhmemory_shared_ptr<document>& doc)
{
	media_query::ptr query = lhmemory_make_shared<media_query>();
...
litehtml::media_query_list::ptr litehtml::media_query_list::create_from_string(const tstring& str, const lhmemory_shared_ptr<document>& doc)
{
	media_query_list::ptr list = lhmemory_make_shared<media_query_list>();
	...
	{
		list = litehtml::media_query_list::ptr();
	}

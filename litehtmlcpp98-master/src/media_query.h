...
namespace litehtml
{
	...
	{
	public:
		typedef lhmemory_shared_ptr<media_query>	ptr;
	...
	public:
		...
		static media_query::ptr create_from_string(const tstring& str, const lhmemory_shared_ptr<document>& doc);
		bool check(const media_features& features) const;
	};
	...
	{
	public:
		typedef lhmemory_shared_ptr<media_query_list>	ptr;
	...
	public:
		...
		static media_query_list::ptr create_from_string(const tstring& str, const lhmemory_shared_ptr<document>& doc);
		bool is_used() const;
